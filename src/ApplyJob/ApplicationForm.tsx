...
import { getBase64 } from "../Services/Utilites";
...
const ApplicationForm=()=>{
    ...
    const handleSubmit=async()=>{
        ...
        // check 
        let applicant={...form.getValues(),applicantId:profile.id,resume:resume.split(',')[1]};
        applyJob(id,applicant)
            .then((res)=>{
                setSubmit(false);
                successNotification("Sucess","Application Submitted Successfully");
        ...
        />
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex gap-10 [&>*]:w-1/2">
                    <TextInput {...form.getInputProps('name')} readOnly={preview} variant={preview?"unstyled":"default"} className={`${preview ?"text-mine-shaft-300 font-bold":""}`} label="Full Name" withAsterisk placeholder="Enter name"/>
                ...
                <div className="flex gap-10 [&>*]:w-1/2">
                    <NumberInput {...form.getInputProps('phone')} readOnly={preview} variant={preview?"unstyled":"default"} className={`${preview ?"text-mine-shaft-300 font-semibold":""}`} label="PhoneNumber"  hideControls  withAsterisk placeholder="Enter Phone number"/>
