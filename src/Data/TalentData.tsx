...
const searchField=[
    ...
    {title:"Skills",icon:IconRecharging,options:['HTML','CSS','Java','C++','SpringBoot','Python','C','C#','JavaScript','Ruby','Golang','SQL','MongoDB','Node.js','React','Next.js','Git','Spring','Tailwind','BootStrap','PostgreSQL','AWS','DevOPs','Azure','Google Cloud','Authentication']}
]
const talents = [
    {
      name: "Smarth Phutela",
